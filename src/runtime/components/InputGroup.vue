...
/*
  Target direct children that are typical form controls
  in Maya UI to collapse their borders and rounded corners
*/
...
.maya-input-group> :deep(*:focus-within),
.maya-input-group> :deep(*:hover),
.maya-input-group> :deep(*:active) {
  z-index: 1;
}
